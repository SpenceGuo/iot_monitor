...
class ResisterForm(FlaskForm):
    ...
    repeat_pwd = PasswordField("repeat_pwd", validators=[DataRequired(), Length(5, 25), EqualTo(password)], render_kw={'placeholder:': 'set your password again'})
...
@app.route('/registeraa', methods=['POST', 'GET'])
def registeraa():
